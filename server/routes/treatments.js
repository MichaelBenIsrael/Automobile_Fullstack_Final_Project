...
router.post('/dashboard/createTreatment', async (req, res) => {
    ...
    const treatment = new Treatment({
        treatmentNumber: process.env.treatmentNum,           // environmental variable to serve as an auto increment
    ...
    try{
        ...
        process.env.treatmentNum = parseInt(process.env.treatmentNum) + 1;
